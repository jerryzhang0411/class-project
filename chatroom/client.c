 ...
 */
int connect_to_server(const char *host, const char *port) { // reference: Fall 2016 CS 241 Angrave Lecture Code
    ...
    int getaddr_status = getaddrinfo(host, port, &hints, &result);
    if(getaddr_status != 0){
