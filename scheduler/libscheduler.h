...
typedef struct _job_t {
    int id;
    int priority;
    double arrival_time; // time that the job arrive on queue
    double execution_time; // time that the job need to use to exectute (i.e. burst time)
    double start_execution_time; // time that job starts executing
    double complete_time; // time that job finished
    double remaining_time; // time that job still need to take to finish
