...
vector *vector_create(copy_constructor_type copy_constructor,
  ...
  // ready.
  vector* retVal = malloc(sizeof(copy_constructor_type) + sizeof(destructor_type) + sizeof(default_constructor_type) + sizeof(void**) + sizeof(size_t)*2);
  retVal->copy_constructor = copy_constructor;
  retVal->destructor = destructor;
  retVal->default_constructor = default_constructor;
  retVal->array = malloc(INITIAL_CAPACITY*sizeof(void*));
  retVal->size = 0;
...
void vector_push_back(vector *this, void *element) {
  ...
  if(this->size < this->capacity){
    ...
    size_t tempCapacity = get_new_capacity(this->size+1);
    this->array = realloc(this->array, tempCapacity*sizeof(void*));
    this->array[this->size] = this->copy_constructor(element);
